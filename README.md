...
Kun Data provides real-time market data for Germany through a token-authenticated API stack designed for charting tools, watchlists, market overview pages, brokerage dashboards, and quant workflows.

This repository focuses on Germany market coverage with support for FWB, XETR.

## API Capabilities

- Real-time WebSocket market data for Germany
...
This repository is designed to make Germany market API coverage easier to discover and evaluate.

## Links

- Website: https://kun.pro/markets/germany-stock-market-api
